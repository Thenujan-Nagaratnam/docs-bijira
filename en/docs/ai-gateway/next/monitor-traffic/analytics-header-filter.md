...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/monitor-traffic/analytics-header-filter/
md_url: https://wso2.com/api-platform/docs/ai-gateway/monitor-traffic/analytics-header-filter.md
tags:
  - ai-gateway
  - analytics
  - policies
