...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/setup-and-deployment/overview/
md_url: https://wso2.com/api-platform/docs/ai-gateway/setup-and-deployment/overview.md
tags:
  - ai-gateway
  - deployment
  - configuration
...
| [Kubernetes deployment modes](kubernetes/overview.md) | Choose between standalone and operator-managed Kubernetes deployment modes for API Platform AI Gateway. |
...
Client credentials on proxies and providers are a separate surface, covered in [Access control](../access-control/overview.md).
...
| Page | What it covers |
|------|----------------|
| [Production deployment overview](production-deployment/overview.md) | Plan a high-availability production deployment of API Platform AI Gateway on Kubernetes with Helm, an external database, and replicated workloads. |
...
| [AI Gateway performance](sizing-and-performance/overview.md) | Review WSO2 API Platform AI Gateway performance test methodology, deployment architecture, metrics, and benchmark results for two-CPU and four-CPU gateway runtimes. |
