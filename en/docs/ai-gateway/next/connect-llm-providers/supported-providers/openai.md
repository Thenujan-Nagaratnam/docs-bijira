...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/connect-llm-providers/supported-providers/openai/
md_url: https://wso2.com/api-platform/docs/ai-gateway/connect-llm-providers/supported-providers/openai.md
tags:
  - ai-gateway
  - llm-provider
  - openai
...
- [Provider templates](../llm-templates.md) — the token and model metadata the `openai` template extracts.
