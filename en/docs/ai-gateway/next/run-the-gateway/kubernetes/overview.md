...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/kubernetes/overview/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/kubernetes/overview.md
tags:
  - ai-gateway
  - kubernetes
  - deployment
