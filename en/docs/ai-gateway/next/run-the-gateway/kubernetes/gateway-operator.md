...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/kubernetes/gateway-operator/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/kubernetes/gateway-operator.md
tags:
  - ai-gateway
  - kubernetes
  - deployment
