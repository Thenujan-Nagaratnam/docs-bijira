...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/kubernetes/kubernetes-standalone/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/kubernetes/kubernetes-standalone.md
tags:
  - ai-gateway
  - kubernetes
  - deployment
