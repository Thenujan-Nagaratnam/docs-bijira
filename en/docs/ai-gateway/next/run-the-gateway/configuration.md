...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/configuration/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/configuration.md
tags:
  - api-gateway
  - configuration
  - interpolation
