...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/production-deployment/database-configuration/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/production-deployment/database-configuration.md
tags:
  - ai-gateway
  - production
  - postgresql
