...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/production-deployment/control-plane-connection/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/production-deployment/control-plane-connection.md
tags:
  - ai-gateway
  - production
  - ai-workspace
