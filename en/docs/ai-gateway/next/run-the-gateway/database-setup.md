...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/database-setup/
md_url: https://wso2.com/api-platform/docs/ai-gateway/run-the-gateway/database-setup.md
tags:
  - ai-gateway
  - configuration
  - postgresql
