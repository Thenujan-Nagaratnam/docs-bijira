...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/control-access/authenticate-clients/
md_url: https://wso2.com/api-platform/docs/ai-gateway/control-access/authenticate-clients.md
tags:
  - ai-gateway
  - security
  - authentication
...
This page covers the data plane, the traffic your applications send. Authentication on the control plane, the REST API you use to manage gateway configuration, is separate and is covered in [Secure the management API](secure-the-management-api.md). The two are configured independently: securing one does nothing for the other.
...
- [Secure the management API](secure-the-management-api.md) — authentication and role-based authorization on the control plane.
- [Control cost and traffic](../control-cost-and-traffic/overview.md) — rate limits and cost controls you can apply to the same operations.
- [Multi-provider routing](../expose-llms/multi-provider-routing.md) — the worked proxy example this page draws its configuration from.
