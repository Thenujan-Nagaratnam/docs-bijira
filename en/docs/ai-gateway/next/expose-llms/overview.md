---
title: "Expose LLMs to applications"
...
canonical_url: https://wso2.com/api-platform/docs/ai-gateway/expose-llms/overview/
md_url: https://wso2.com/api-platform/docs/ai-gateway/expose-llms/overview.md
tags:
  - ai-gateway
  - llm-proxy
  - llm
...
To deploy your first LLM proxy against a configured provider, see [Quick Start Guide](../quick-start-guide.md).
